...
robot1_l = RobotArmController(ROBOT1_L_IP, 8080, 3)
robot1_r = RobotArmController(ROBOT1_R_IP, 8080, 3)
robot2_l = RobotArmController(ROBOT2_L_IP, 8080, 3)
robot2_r = RobotArmController(ROBOT2_R_IP, 8080, 3)
robot3_l = RobotArmController(ROBOT3_L_IP, 8080, 3)
robot3_r = RobotArmController(ROBOT3_R_IP, 8080, 3)
robot4_l = RobotArmController(ROBOT4_L_IP, 8080, 3)
robot4_r = RobotArmController(ROBOT4_R_IP, 8080, 3)
robot5_l = RobotArmController(ROBOT5_L_IP, 8080, 3)
robot5_r = RobotArmController(ROBOT5_R_IP, 8080, 3)

robot1_l.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot1_r.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot2_l.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot2_r.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot3_l.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot3_r.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot4_l.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot4_r.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot5_l.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
robot5_r.Set_Modbus_Mode(COM_PORT, BAUD_RATE, TIMEOUT)
